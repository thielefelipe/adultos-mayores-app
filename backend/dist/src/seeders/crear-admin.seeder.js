...
exports.CrearAdminSeeder = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const bcrypt = __importStar(require("bcrypt"));
const entities_1 = require("../entities");
let CrearAdminSeeder = class CrearAdminSeeder {
    usuarioRepository;
    logger = new common_1.Logger('CrearAdminSeeder');
...
exports.CrearAdminSeeder = CrearAdminSeeder;
exports.CrearAdminSeeder = CrearAdminSeeder = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(entities_1.UsuarioEntity)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], CrearAdminSeeder);
//# sourceMappingURL=crear-admin.seeder.js.map