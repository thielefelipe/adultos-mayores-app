...
interface UsuariosConectadosProps {
  onVolver: () => void;
  onLogout: () => void;
}

export function UsuariosConectados({ onVolver, onLogout }: UsuariosConectadosProps) {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(cargarUsuariosActivos, 10000);
    ...
    <div style={{
      ...
      <main style={{ maxWidth: 1200, margin: '0 auto', padding: '40px 24px' }}>
        ...
        <p style={{ color: '#666666', fontSize: 14, marginBottom: 30 }}>
          Total activos en este momento: <strong>{usuariosActivos.length}</strong>
        </p>
        ...
        {cargando ? (
          ...
          <div style={{
            ...
            <table style={{
              ...
              <tbody>
                {usuariosActivos.map((u, index) => (
                  <tr key={u.id} style={{
                    borderBottom: index < usuariosActivos.length - 1 ? '1px solid #E0E0E0' : 'none',
          ...
          <div style={{
            ...
            <p style={{ fontSize: 16, marginBottom: 8 }}>No hay usuarios conectados en este momento</p>
            <p style={{ fontSize: 13 }}>Los operadores y analistas aparecerán aquí cuando se conecten</p>
          </div>
        )}
      </main>
    </div>
